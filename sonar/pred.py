...
from tensorflow.keras.layers import Conv2D, Dense, Input, BatchNormalization, Dropout,Flatten
...
def build_model(input_shape, n_classes):
    ...
    feature = Flatten()(x)    
    x = Dense(128, activation='relu')(feature)
...
model = build_model(input_shape=(64,64,3), n_classes=8)

with tf.keras.utils.custom_object_scope(custom_objects):
    #model = load_model('FLSMDD_ori')
    model = load_model('NKSID_ori')
